                    ...
                    <tbody>
                      {inventory.medical_supplies.map((i, idx) => (
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                          <td className="px-6 py-4 font-semibold text-gray-900">{i.item}</td>
                          ...
                          <td className="px-6 py-4 text-gray-900 font-semibold">₹{i.cost}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {inventory.equipment.map((i, idx) => (
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                          <td className="px-6 py-4 font-semibold text-gray-900">{i.equipment}</td>
                          <td className="px-6 py-4">
                            <span
                              className={`px-3 py-1 rounded-full text-xs font-bold ${
